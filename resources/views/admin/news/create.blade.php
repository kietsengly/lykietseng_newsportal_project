...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1 style="font-family: 'Battambang', cursive;">{{ __('admin.News') }}</h1>
        </div>

        <div class="card card-primary">
            <div class="card-header">
                <h4 style="font-family: 'Battambang', cursive;">{{ __('admin.Create News') }}</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="content" class="summernote-simple"
                                  style="font-family: 'Battambang', cursive;"></textarea>
                        @error('content')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
